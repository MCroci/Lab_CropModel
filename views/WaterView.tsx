          ...
          <Card title="Teoria: Bilancio Idrico a Secchio" className="bg-slate-50 border-slate-200" headerAction={<BookOpen className="text-slate-400"/>}>
            <div className="prose prose-sm max-w-none text-slate-700">
              ...
              <ul className="list-disc list-inside text-xs space-y-1">
                ...
                <li><strong>FTSW (Frazione Acqua Traspirabile):</strong> FTSW = ATSW/TTSW = (W - WP)/(FC - WP). Indica quanto del totale transpirabile è disponibile. FTSW &lt; 0.2–0.3 indica stress idrico.</li>
                <li><strong>ARID (Indice di Aridità):</strong> ARID = 1 - T_act/ET₀. Se la pianta non riesce a soddisfare la domanda evapotraspirativa, va in stress (ARID &gt; 0).</li>
              </ul>
            </div>
          </Card>
