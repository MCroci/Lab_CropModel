...
export const CropComparisonView: React.FC = () => {
  ...
  if (dailyWeather.length === 0) {
    return (
      <Card title="Confronto Colture - Simulazioni Parallele">
        <div className="text-center py-8">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 max-w-md mx-auto">
            <p className="text-yellow-800 font-medium mb-2">⚠️ Dati meteorologici mancanti</p>
            <p className="text-sm text-yellow-700 mb-4">
              Per eseguire simulazioni parallele, devi prima generare i dati meteorologici.
            </p>
            <p className="text-sm text-yellow-700">
              Vai alla sezione <strong>Generatore Meteo</strong> nel menu laterale e genera i dati meteo.
              Poi torna qui per confrontare le colture!
            </p>
          </div>
        </div>
      </Card>
  ...
  return (
    <div className="space-y-6">
      <Card title="Confronto Multi-Coltura - Simulazioni Parallele">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
          ...
          <ol className="list-decimal list-inside space-y-1 text-sm text-blue-800">
            ...
            <li>Le <strong>simulazioni vengono eseguite automaticamente in parallelo</strong> per tutte le colture selezionate</li>
            <li>Ogni coltura usa le <strong>stesse condizioni meteorologiche</strong> (dalla sezione Generatore Meteo)</li>
            <li>I risultati vengono mostrati <strong>sovrapposti nei grafici</strong> per un confronto diretto</li>
          </ol>
        </div>
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
          <p className="text-sm text-blue-800">
            <strong>Date di Semina:</strong> Ogni coltura può avere una data di semina diversa (configurabile nella sezione Panoramica).
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-gray-900">Seleziona Colture da Confrontare</h3>
      ...
      {comparisonResults.length > 0 && (
        <>
          ...
          <Card title="Simulazioni Eseguite" className="bg-green-50 border-green-200">
          ...
          <Card title="Risultati Finali della Simulazione">
